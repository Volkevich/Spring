...
import com.volkevich.InstaZoo.exeptions.PostNotFoundException;
import com.volkevich.InstaZoo.repository.ImageRepository;
import com.volkevich.InstaZoo.repository.PostRepository;
...
public class PostService {
    ...
    public Post getPostById(Long postID, Principal principal) {
        User user = getUserByPrincipal(principal);
        return postRepository.findPostByIdAndUser(postID, user).orElseThrow(() -> new PostNotFoundException("Post cannot be found for username: " + user.getEmail()));
    }

    public List<Post> getAllPostFroUser(Principal principal) {
        User user = getUserByPrincipal(principal);
