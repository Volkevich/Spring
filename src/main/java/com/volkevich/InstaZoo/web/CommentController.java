...
import com.volkevich.InstaZoo.facade.CommentFacade;
import com.volkevich.InstaZoo.payload.reponse.MessageResponse;
import com.volkevich.InstaZoo.services.CommentService;
...
public class CommentController {
    ...
    public ResponseEntity<List<CommentDTO>> getAllCommentsToPost(@PathVariable("postId") String postId) {
        List<CommentDTO> commentDTOS = commentService.getAllCommentsForPost(Long.parseLong(postId))
                .stream().map(commentFacade::commentToCommentDTO).toList();
